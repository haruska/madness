...
Passwordless.default_from_address = 'help@example.com'
...
Passwordless.failure_redirect_path = '/sign-in' # When a a login is failed for any reason.
Passwordless.sign_out_redirect_path = '/sign-in' # When a user logs out.
